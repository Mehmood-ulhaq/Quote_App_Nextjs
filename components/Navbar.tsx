...
const Navbar = () => {
  ...
  const isLoggingPage = router.pathname === "/login";
  ...
  const avatar = (<div className='group relative'>
                    ...
                    <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                        <div className='flex flex-col gap-2 w-36  bg-gray-500 text-white-500 rounded'>
                            <p className='cursor-pointer hover:text-gray-300 hover:bg-gray-700 py-3 px-5 rounded' onClick={handleLogout}>Logout</p>
                        </div>
                    </div>
  </div>)
